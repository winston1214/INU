...
def naver(keyword,op='None'):
    ...
    while True:
        url='https://search.naver.com/search.naver?where=news&query={}&sm=tab_opt&sort=0&photo=0&field=0&pd=3&ds=2021.01.15&de=2021.10.16&start={}'.format(word_encode,start)
